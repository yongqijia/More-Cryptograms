...
public class Cryptograms {
	 ...
	 * 
	 * @param cryptogram the hashmap that contain the correct the mapping.
	 * 
	 * @param target the quotes that has already been encrypted.
	 */
	public static void decryption(String encrypted_quotes, HashMap<Character, Character> cryptogram, String target) {
		...
		while(check) {
		    ...
		    // Update the hashmap which is used to store the user guesses.
		    for(int i = 0; i < encrypted_quotes.length(); i++) {
	 ...
	 * @param target the quotes that has already been encrypted.
	 */
	public static void hint(HashMap<Character, Character> cryptogram, String encrypted_quotes, 
	 ...
	 * First create an additional hashmap to store the frequency. Then loop the encrypted_quotes
	 ...
	 * 
	 * @param cryptogram the hashmap the contain the correct mapping.
	 * 
	 ...
	 * 
	 * First create a hashmap that contain alphabetical order.
	 * Using shuffle to create mappings.
	 * 
	 * @return a hashmap contain correct mapping
	 */
